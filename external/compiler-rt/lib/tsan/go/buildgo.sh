...
FLAGS=" -I../rtl -I../.. -I../../sanitizer_common -I../../../include -m64 -Wall  -Wno-maybe-uninitialized -fno-exceptions -fno-rtti -DTSAN_GO -DSANITIZER_GO -DTSAN_SHADOW_COUNT=4 $OSCFLAGS"
if [ "$DEBUG" == "" ]; then
